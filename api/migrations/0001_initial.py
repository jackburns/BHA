# -*- coding: utf-8 -*-
# Generated by Django 1.9.3 on 2016-04-03 06:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volunteer_level', models.IntegerField(choices=[(0, 'Unverified'), (1, 'Verified'), (2, 'Trained'), (3, 'hasObserved'), (4, 'beenObserved')], default=0)),
        ...
        migrations.AddField(
            model_name='language',
            name='volunteer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Volunteer'),
        ),
        migrations.AddField(
